...
final class DhcrHelpContentController extends ControllerBase {

  public const USERS_ACCESS_WORKFLOWS_CONTENT_STATE_KEY = 'dhcr_backend.users_access_workflows_content';
  public const USERS_ACCESS_WORKFLOWS_FORMAT_STATE_KEY = 'dhcr_backend.users_access_workflows_format';
  public const USERS_ACCESS_WORKFLOWS_DEFAULT_FORMAT = 'full_html';
  public const USERS_ACCESS_WORKFLOWS_DEFAULT_CONTENT = <<<'HTML'
  ...
  <ol>
    ...
    <ol>
      <li>Create an account by filling in the
        <a href="/users/register">User Registration form</a>.</li>
    ...
    <ol>
      ...
      <li>Go to the Contributor Network and click on
        <a href="/users/invite">Invite User</a> to fill in the
        invitation form:
        <ol type="a">
    ...
    <p>To help the course maintainers, a traffic-light colour is used in the list of courses to indicate their status:
      ...
      are sent to the course owners regularly to update the metadata of their courses.</p>
    <ol>
      ...
      <li>After <u>12 months</u>, the moderator will be on the CC of the reminder emails. The course status is
        <font color="orange"><strong>orange</strong></font>.</li>
...
HTML;
  ...
  public function usersAccessWorkflows(): array {
    $state = \Drupal::state();
    $content = (string) $state->get(self::USERS_ACCESS_WORKFLOWS_CONTENT_STATE_KEY, self::USERS_ACCESS_WORKFLOWS_DEFAULT_CONTENT);
    $format = (string) $state->get(self::USERS_ACCESS_WORKFLOWS_FORMAT_STATE_KEY, self::USERS_ACCESS_WORKFLOWS_DEFAULT_FORMAT);

    return [
      '#theme' => 'dhcr_help_content',
      '#edit_url' => Url::fromRoute('dhcr_backend.help_users_access_workflows_edit')->toString(),
      '#content' => [
        '#type' => 'processed_text',
        '#text' => $content,
        '#format' => $format,
